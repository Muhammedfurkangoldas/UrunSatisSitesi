...
namespace UrunSatisSitesi.Entities
{
    public class Product : IEntitiy
    {
        ...
        [Display(Name = "Kategori")]
        public virtual Category? Category { get; set; }//1 ürünün 1 tane kategorisi olabilir.(birebir ilişki)
        [Display(Name = "Marka")]
        public int BrandId { get; set; }
        [Display(Name = "Marka")]
        public virtual Brand? Brand { get; set; }//1 ürünün 1 tane markası olabilir.(birebir ilişki)
